...
export const adminApi = {
  ...
  updateUserPassword: (userId: string, input: UpdateUserPasswordInput) => request<{ updated: boolean; setupInviteUrl?: string | null; emailDeliveryStatus?: AdminUser["emailDeliveryStatus"]; emailDeliveryError?: string | null }>(`/api/admin/users/${userId}/password`, { method: "PATCH", body: JSON.stringify(input) }),
